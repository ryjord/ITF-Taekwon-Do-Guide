...
const socialLinks = [
  ...
  {
    platform: 'facebook',
    url: 'https://www.facebook.com/TrenicTaekwon-Do/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
 ...
 * - Inspirational Taekwon-Do philosophy quote
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-6 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <div className="text-foreground/60 text-sm">
            © {new Date().getFullYear()} ITF Taekwon-Do Guide. All rights reserved.
          </div>
        ...
        <div className="pb-6 text-center">
          <p className="text-foreground/40 text-sm italic max-w-2xl mx-auto leading-relaxed">
            "The ultimate goal of Taekwon-Do is to eliminate fighting by discouraging the stronger's 
